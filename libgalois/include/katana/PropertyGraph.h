...
public:
  ...
  PropertyView node_property_view() const {
    return PropertyView{
        .g = nullptr,
        .const_g = this,
        .schema_fn = &PropertyGraph::node_schema,
        ...
        .property_fn_str = &PropertyGraph::GetNodeProperty,
        .property_num_fn = &PropertyGraph::GetNumNodeProperties,
        .add_properties_fn = nullptr,
        .upsert_properties_fn = nullptr,
        .remove_property_int = nullptr,
        .remove_property_str = nullptr,
    };
  }
  ...
  PropertyView edge_property_view() const {
    return PropertyView{
        .g = nullptr,
        .const_g = this,
        .schema_fn = &PropertyGraph::edge_schema,
...
/// Report approximate memory use for a property view
KATANA_EXPORT uint64_t ApproxMemUse(const PropertyGraph::PropertyView& pview);
